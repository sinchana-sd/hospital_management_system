<?php
    ...
    if(isset($_POST['create']))
    {
        ...
        if(count($error) == 0)
        {
            $query = "INSERT INTO patient(firstname,surname,username,email,phone,gender,country,password, data_reg, profile,doc_id) VALUES ('$fname','$sname','$uname','$email','$phone','$gender','$country','$password',NOW(),'patient1.jpg','$doc_id')";
            ...
            <div class="row">
                ...
                <div class="col-md-6 my-2 jumbotron">
                    ...
                    <form method="post">
                        ...
                        <div class="form-group">
                            <label>Doc_id</label>
                            <input type="number" name="doc_id" class="form-control"
                            autocomplete="off" placeholder="Enter doctor ID">
                        </div>
